...
fun DetalleScreen(){
    Column(
        modifier = Modifier
            ...
            .padding(all = 16.dp).verticalScroll(rememberScrollState()),
        ...
        Button(
            onClick = {},
            colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF1E1093)),
            shape = RoundedCornerShape(12.dp),
            modifier = Modifier
                .fillMaxWidth()
                .height(44.dp)
        ...
        Button(
            onClick = { },
            colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFFFDCDC)),
            shape = RoundedCornerShape(12.dp),
            modifier = Modifier
                .fillMaxWidth()
                .height(44.dp)
        ) {
            Icon(imageVector = Icons.Default.Delete, contentDescription = null, tint = Color(0xFFB3261E), modifier = Modifier.size(16.dp))
            Spacer(modifier = Modifier.width(8.dp))
            Text(text = "Eliminar", color = Color(0xFFB3261E), fontWeight = FontWeight.Bold)
        }
